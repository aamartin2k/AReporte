...
{
    //  AsistenciaQueryData
    public class AsistenciaQueryData
    {
        ...
        public AsistenciaQueryResult Handle(AsistenciaQuery query)
        {
            ...
            ConjuntoDatosAsistencia ret = new ConjuntoDatosAsistencia(causasInc, colIncidencias, colEmpleados);

            // retornando
            return new AsistenciaQueryResult(ret);
        }
